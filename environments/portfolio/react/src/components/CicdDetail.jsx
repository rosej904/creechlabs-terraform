  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed mb-4">
        Placeholder elaboration — the EKS cluster and everything it hosts is
        ...
        scale-down; the cluster and its workloads cease to exist entirely
        between 5pm and 8:30am ET.
      </p>
      <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed mb-6">
        Placeholder elaboration — why this pattern, and what it took to get
        the destroy order right (particularly around load balancers created
        outside the main shared ALB group, which need explicit cleanup
        before the networking layer can be torn down).
      </p>
      ...
      <div className="border-t border-[var(--color-border)] pt-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg px-4 py-3">
            <span className="text-sm font-medium">dns-tls, cicd, bootstrap</span>
